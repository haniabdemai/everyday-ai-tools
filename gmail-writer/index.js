 ...
 *
 * Token: ~/.gmail_token.json (created by oauth_bootstrap.py in this
 * directory; see README). The token file is self-contained. It includes
 * client_id, client_secret, and refresh_token, so no separate credentials
 * file is needed.
 *
    ...
    inputSchema: {
      ...
      properties: {
        ...
        addLabelIds: {
          ...
          items: { type: "string" },
          description:
            "Label IDs to add. System labels: INBOX, TRASH, SPAM, STARRED, UNREAD, IMPORTANT. User labels: use gmail_list_labels to find IDs.",
        },
        removeLabelIds: {
          type: "array",
          items: { type: "string" },
        ...
        content: [
          {
            ...
            text:
              ...
              "path/to/client_secret.json (see README)",
          },
        ],
        isError: true,
      };
